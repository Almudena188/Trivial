...
public class trivial {
	...
	public static void main(String[] args) {
		...
		// como solo existen 6 categorias le damos paso al usario para que elija las preguntas siguientes hasta que se hagan 10 preguntas en total
		...
		JOptionPane.showMessageDialog(null, "TRIVIAL TERMINADO\n"
				+ "Sus puntos obtenidos son: " + contPuntos, "FIN", JOptionPane.QUESTION_MESSAGE);
